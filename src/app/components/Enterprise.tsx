...
function AlbumShowcase({ images, alt }: { images: string[]; alt: string }) {
      ...
      <div className="max-w-[1260px] mx-auto">
        ...
        >
          ...
          <h2 className="mt-5 text-[clamp(2rem,4.8vw,3.2rem)] font-semibold leading-[1.12] tracking-[-0.03em] text-white">
            Commercial-Grade AI Team Operations
          </h2>
          <p className="mt-4 text-[16px] leading-[1.72] text-slate-300/88">
            From team design to runtime governance, Starfire ships the capabilities enterprises need to run
            AI agent teams in production, not just prototypes.
          </p>
        </motion.div>
              ...
              >
                <div className="grid gap-6 md:gap-8 items-center lg:grid-cols-2">
                  <div className={`${imageClass} w-full`}>
                    <AlbumShowcase images={slice.images} alt={slice.title} />
                  </div>
