...
export function MemoryArchitecture({ locale }: MemoryArchitectureProps) {
  ...
  return (
    <section id={sectionIds.memory} className="relative px-6 py-20 md:py-24 bg-[#0d1729] border-y border-white/[0.08]">
      ...
      <div className="max-w-[1260px] mx-auto relative">
        ...
        >
          ...
          <h2
            className="mt-5 text-[clamp(2rem,4.9vw,3.3rem)] font-semibold leading-[1.1] tracking-[-0.03em] text-white"
        ...
        <motion.div
          ...
          className="rounded-2xl border border-white/[0.12] bg-[#13223a] p-5 md:p-6 mb-4"
        >
