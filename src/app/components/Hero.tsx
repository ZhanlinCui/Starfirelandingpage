      ...
      <div className="relative max-w-[1280px] mx-auto">
        ...
        >
          ...
          <p className="mt-8 text-[16px] leading-[1.74] text-slate-100/95 max-w-[860px] mx-auto">
            Starfire is the organizational operating system for agent teams. Define hierarchical authority,
            topology-scoped memory, and runtime isolation in one visual control plane.
          </p>
        </motion.div>
