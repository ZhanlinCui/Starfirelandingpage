...
export function MarketMomentum({ locale }: MarketMomentumProps) {
  ...
  return (
    <section id={sectionIds.whyNow} className="px-6 py-7 md:py-9">
      <div className="max-w-[1260px] mx-auto">
        ...
        >
          ...
          <h2
            className="mt-3 text-[clamp(1.5rem,3.2vw,2.15rem)] font-semibold leading-[1.15] tracking-[-0.02em] text-white"
        ...
        <div className="grid md:grid-cols-2 xl:grid-cols-4 gap-3.5">
          {copy.signals.map((signal, index) => (
            <motion.article
              ...
              className="rounded-2xl border border-white/[0.13] bg-[#121e34] p-4 md:p-5 shadow-[0_12px_35px_rgba(0,0,0,0.28)]"
            >
